...
#define Analog_input_PC3_Pin GPIO_PIN_3
#define Analog_input_PC3_GPIO_Port GPIOC
...
#define Pousoir_Pin GPIO_PIN_11
#define Pousoir_GPIO_Port GPIOA
#define Pousoir_EXTI_IRQn EXTI15_10_IRQn
